...
exports.AddGameRequest = void 0;
const class_validator_1 = require("class-validator");
exports.AddGameRequest = (() => {
    var _a;
    let _instanceExtraInitializers = [];
    let _name_decorators;
    let _name_initializers = [];
    return _a = class AddGameRequest {
            constructor() {
                this.name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _name_initializers, void 0));
            }
        },
        (() => {
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 20)];
